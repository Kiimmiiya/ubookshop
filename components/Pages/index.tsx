...
const Page: PageEl = (props, state:
  ...
  return (
    <div style={{ direction: "rtl", minHeight: "11vh", }}>
      ...
      <Window title="Shopping bag"style={{ margin: 10 , width: "calc(100% - 20px)", backgroundColor:"#DCD5D5"}} >
        <f-cse style={{
      ...
      style={{ minHeight: 200, margin: 10 , width: "calc(100% - 20px)" , backgroundColor:"#DCD5D5" }}>
